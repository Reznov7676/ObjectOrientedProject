...
public class HomePage_SwagLabs_VerifyAddToCart_TestCase_4 extends BaseTest {
	...
	public void lg(String User , String pas) throws FileNotFoundException, IOException, ParseException, InterruptedException {
		...
		page.getInstance(HomePageObjectsAndpageActions.class).verifyAddtoCartnumber(5);
